...
if args.dataset == 'miniImagenet':
    args.base_features_path = 'few-shot-learning/data/miniImagenet/base_features.plk'
    args.novel_features_path = 'few-shot-learning/data/miniImagenet/novel_features.plk'
elif args.dataset == 'CUB':
    args.base_features_path = 'few-shot-learning/data/CUB/base_features.plk'
    args.novel_features_path = 'few-shot-learning/data/CUB/novel_features.plk'
elif args.dataset == 'StanfordDogs':
    args.base_features_path = 'few-shot-learning/data/StanfordDogs/base_features.plk'
    args.novel_features_path = 'few-shot-learning/data/StanfordDogs/novel_features.plk'
...
log_file = os.path.join('few-shot-learning/logs/', args.xpid+'.log')
